            ...
            <div className="Home home-container container">
                ...
                <div className="row justify-content-around align-items-center">
                    <div className="col-md-6 text-cetner">
                        ...
                        <img className="mt-2 me-2 img-fluid d-none d-md-block" src="src\assets\imagen skillsync-01.png" alt="" width={600} />
                        <img className="mt-2 me-2 img-fluid d-md-none" src="src\assets\imagen skillsync-01.png" alt="" width={400} />
                    </div>
